...
class Config(object):
    ...
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "@HatakeKakashi41") # Bot username without @.
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', '7093f846c0cb92afe2a6b65b7581f835f7a39b21') # your url shortner api
